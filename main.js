var SYMBOLLIST = [
    ...
    ["Laimas krusts	", "laika un likteņa", 1, "Simbolizē likteni un svētību. Krusts attēlo Dievu centrā un pasaules spēkus tās atzarojumos (2, 81).", "laimas krusts.svg"],
    ...
    ["Mēness krusts", "dieva un pasaules", 0, "Simbolizē dzīvību un iznīcību. Saistīta ar zemkopību. Krusts simbolizē četras Mēness fāzes (2, 74-75).","menesskrustss.svg"],
